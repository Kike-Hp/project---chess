...
class BoardGuiTk(tk.Frame):
    ...
    def move(self, p1, p2):
        ...
        if dest_piece is None or dest_piece.color != piece.color:
            try:
                ...
                tkMessageBox.showinfo('', error.__class__.__name__)
            else:
                self.label_status["text"] = " " + piece.color.capitalize() +": "+ p1 + ' to ' + p2
    ...
    def draw_pieces(self):
        ...
        for coord, piece in self.chessboard.iteritems():
            ...
            if piece is not None:
                filename = "pieces_image/%s%s.png" % (piece.abbriviation.lower(), piece.color)
    ...
    def reset(self):
        self.chessboard.load(chessboard.FEN_STARTING)
        self.refresh()
        self.draw_pieces()
        self.refresh()
